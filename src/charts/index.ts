...
export { koreaDistrictMap as "korea-district-map" } from "./korea-district-map";
export { koreaPinMap as "korea-pin-map" } from "./korea-pin-map";
export { koreaPathMap as "korea-path-map" } from "./korea-path-map";
