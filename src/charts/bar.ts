...
const schema = {
  data: z
    .array(data)
    .describe(
      "Data for bar chart, such as, [{ category: 'Category A', value: 10 }, { category: 'Category B', value: 20 }], when grouping or stacking is needed for bar, the data should contain a `group` field, such as, when [{ category: 'Beijing', value: 825, group: 'Gas' }, { category: 'Beijing', value: 1000, group: 'Electric' }].",
    )
